import type { Education, SkillGroup, WorkExperience } from '../types/site';
...
export const work: readonly WorkExperience[] = [
  {
    company: 'Handshake',
    summary: 'Senior Engineer → Founding Engineer',
    period: '2024 — now',
  ...
  {
    company: 'LinkedIn',
    summary: 'Apprentice Engineer → Senior Software Engineer',
    period: '2019 — 2024',
    ...
    roles: [
      {
        ...
        highlights: [
          'Taught software engineering at the coding bootcamp where I learned to code.',
        ],
      },
    ],
  },
...
export const education: readonly Education[] = [
  {
    school: 'Hack Reactor',
    qualification: 'Full-Stack Software Engineering Program',
  ...
  },
  {
    ...
    qualification: 'B.A., Political Science & Leadership Studies, cum laude',
  ...
  },
  {
    ...
    qualification: 'Visiting Student, Williams-Exeter Programme',
    period: 'September 2013 — September 2014',
    location: 'Oxford, England, United Kingdom',
    href: 'https://www.exeter.ox.ac.uk/',
    brand: 'exeter',
  },
];
...
export const skills: readonly SkillGroup[] = [
  {
    label: 'Technologies',
    items:
      'JavaScript, TypeScript, React, Next.js, React Native, GraphQL, tRPC, PostgreSQL, Ruby on Rails, Python, Ember.js, HTML, CSS, Tailwind CSS, LaunchDarkly, Datadog, Puppeteer, Jest',
  },
  { label: 'AI-assisted development', items: 'Claude Code, Codex, Cursor' },
  {
    label: 'Languages',
    items: 'English (native), Spanish (intermediate proficiency)',
  },
];
